 ...
 * @author Tyler (Twdtwd)
 */
public class IntervalAction extends AbstractQuestAction {
    private long interval = -1;
    private final int questID;

    public IntervalAction(Quest quest, Data data) {
        super(QuestActionType.INTERVAL, quest);
        questID = quest.getId();
        processData(data);
    }
    ...
    private static String getIntervalTimeLeft(Character chr, IntervalAction r) {
