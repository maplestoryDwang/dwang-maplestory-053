-- =========================================================================
-- DML 数据初始化 (针对 NPC: 2040016 派 / 玩具城 精炼师) - 变量动态主键版
-- 功能: 精炼矿石 / 精炼宝石 / 精炼稀有宝石 / 精炼水晶矿石 / 制作材料 / 制作箭矢
-- 费用为 2020000 的 90%
-- =========================================================================

-- 插入npc总表记录
DELETE FROM `npc_craft_list` WHERE `npc_id` = 2040016;
INSERT INTO `npc_craft_list` (`npc_id`) values (2040016);

-- =========================================================================
-- 1. 台词配置 (npc_dialog)
-- =========================================================================
DELETE FROM `npc_dialog` WHERE `npc_id` = 2040016 AND `dialog_type` = 'craft';

INSERT INTO `npc_dialog` (`npc_id`, `template_id`, `dialog_type`, `dialog_key`, `dialog_text`) VALUES
(2040016, 1, 'craft', 'craft_start', '嗯？你是谁？哦，你听说过我的锻造技术？如果是这样的话，我会很乐意帮你加工一些矿石……不过需要收费。#b'),
(2040016, 1, 'craft', 'quantity_prompt_refine', '那么，你想让我制作一些#i{item}##t{item}#吗？你希望我制作多少？'),
(2040016, 1, 'craft', 'quantity_prompt_free', '那么，你想让我制作一些#i{item}##t{item}#吗？你希望我制作多少？'),
(2040016, 1, 'craft', 'no_space', '恐怕您在此交易中没有可用的插槽。'),
(2040016, 1, 'craft', 'no_meso', '恐怕你支付不起我的服务费。'),
(2040016, 1, 'craft', 'no_mat', '等一下，如果没有所有必要的材料，我无法完成。先把它们带来，然后我们再谈。'),
(2040016, 1, 'craft', 'craft_cancel_start', '好的，下次有需要再来找我。'),
(2040016, 1, 'craft', 'craft_cancel_menu', '收集齐材料后再来找我吧！'),
(2040016, 1, 'craft', 'craft_menu_title', '请选择制作类型：#b'),
(2040016, 1, 'craft', 'craft_success', '都搞定了。如果你需要其他的东西，你知道在哪里找到我。');
...
DELETE FROM `npc_craft_mat` WHERE `recipe_id` IN (
    SELECT `id` FROM `npc_craft_item` WHERE `category_id` IN (
        SELECT `id` FROM `npc_craft_cat` WHERE `npc_id` = 2040016
    )
);
DELETE FROM `npc_craft_item` WHERE `category_id` IN (
    SELECT `id` FROM `npc_craft_cat` WHERE `npc_id` = 2040016
);
DELETE FROM `npc_craft_cat` WHERE `npc_id` = 2040016;
...
(2040016, 0, '精炼矿石', 1, 'MATERIAL_BATCH', '那么，你想要精炼哪种矿石呢？#b', '');
SET @cat_ore = LAST_INSERT_ID();

-- 配方 0-0: 青铜成品 (4011000)
INSERT INTO `npc_craft_item` (`category_id`, `item_id`, `is_equip`, `yield_qty`, `req_level`, `job_name`, `cost`, `sort_order`) VALUES (@cat_ore, 4011000, 0, 1, 0, '', 270, 1);
SET @rec_id = LAST_INSERT_ID();
INSERT INTO `npc_craft_mat` (`recipe_id`, `mat_id`, `mat_qty`) VALUES (@rec_id, 4010000, 10);

-- 配方 0-1: 钢铁成品 (4011001)
INSERT INTO `npc_craft_item` (`category_id`, `item_id`, `is_equip`, `yield_qty`, `req_level`, `job_name`, `cost`, `sort_order`) VALUES (@cat_ore, 4011001, 0, 1, 0, '', 270, 2);
SET @rec_id = LAST_INSERT_ID();
INSERT INTO `npc_craft_mat` (`recipe_id`, `mat_id`, `mat_qty`) VALUES (@rec_id, 4010001, 10);

-- 配方 0-2: 朱矿石成品 (4011002)
INSERT INTO `npc_craft_item` (`category_id`, `item_id`, `is_equip`, `yield_qty`, `req_level`, `job_name`, `cost`, `sort_order`) VALUES (@cat_ore, 4011002, 0, 1, 0, '', 270, 3);
SET @rec_id = LAST_INSERT_ID();
INSERT INTO `npc_craft_mat` (`recipe_id`, `mat_id`, `mat_qty`) VALUES (@rec_id, 4010002, 10);

-- 配方 0-3: 银成品 (4011003)
INSERT INTO `npc_craft_item` (`category_id`, `item_id`, `is_equip`, `yield_qty`, `req_level`, `job_name`, `cost`, `sort_order`) VALUES (@cat_ore, 4011003, 0, 1, 0, '', 450, 4);
SET @rec_id = LAST_INSERT_ID();
INSERT INTO `npc_craft_mat` (`recipe_id`, `mat_id`, `mat_qty`) VALUES (@rec_id, 4010003, 10);

-- 配方 0-4: 紫矿石成品 (4011004)
INSERT INTO `npc_craft_item` (`category_id`, `item_id`, `is_equip`, `yield_qty`, `req_level`, `job_name`, `cost`, `sort_order`) VALUES (@cat_ore, 4011004, 0, 1, 0, '', 450, 5);
SET @rec_id = LAST_INSERT_ID();
INSERT INTO `npc_craft_mat` (`recipe_id`, `mat_id`, `mat_qty`) VALUES (@rec_id, 4010004, 10);

-- 配方 0-5: 黄金成品 (4011005)
INSERT INTO `npc_craft_item` (`category_id`, `item_id`, `is_equip`, `yield_qty`, `req_level`, `job_name`, `cost`, `sort_order`) VALUES (@cat_ore, 4011005, 0, 1, 0, '', 450, 6);
SET @rec_id = LAST_INSERT_ID();
INSERT INTO `npc_craft_mat` (`recipe_id`, `mat_id`, `mat_qty`) VALUES (@rec_id, 4010005, 10);

-- 配方 0-6: 盖亚成品 (4011006)
INSERT INTO `npc_craft_item` (`category_id`, `item_id`, `is_equip`, `yield_qty`, `req_level`, `job_name`, `cost`, `sort_order`) VALUES (@cat_ore, 4011006, 0, 1, 0, '', 720, 7);
SET @rec_id = LAST_INSERT_ID();
...
-- =========================================================================
INSERT INTO `npc_craft_cat` (`npc_id`, `menu_index`, `category_name`, `template_id`, `craft_type`, `prompt_text`, `warning_text`) VALUES
(2040016, 1, '精炼宝石', 1, 'MATERIAL_BATCH', '那么，你想要精炼哪种宝石呢？#b', '');
SET @cat_gem = LAST_INSERT_ID();

-- 配方 1-0: 石榴石成品 (4021000)
INSERT INTO `npc_craft_item` (`category_id`, `item_id`, `is_equip`, `yield_qty`, `req_level`, `job_name`, `cost`, `sort_order`) VALUES (@cat_gem, 4021000, 0, 1, 0, '', 450, 1);
SET @rec_id = LAST_INSERT_ID();
INSERT INTO `npc_craft_mat` (`recipe_id`, `mat_id`, `mat_qty`) VALUES (@rec_id, 4020000, 10);

-- 配方 1-1: 紫水晶成品 (4021001)
INSERT INTO `npc_craft_item` (`category_id`, `item_id`, `is_equip`, `yield_qty`, `req_level`, `job_name`, `cost`, `sort_order`) VALUES (@cat_gem, 4021001, 0, 1, 0, '', 450, 2);
SET @rec_id = LAST_INSERT_ID();
INSERT INTO `npc_craft_mat` (`recipe_id`, `mat_id`, `mat_qty`) VALUES (@rec_id, 4020001, 10);

-- 配方 1-2: 水晶成品 (4021002)
INSERT INTO `npc_craft_item` (`category_id`, `item_id`, `is_equip`, `yield_qty`, `req_level`, `job_name`, `cost`, `sort_order`) VALUES (@cat_gem, 4021002, 0, 1, 0, '', 450, 3);
SET @rec_id = LAST_INSERT_ID();
INSERT INTO `npc_craft_mat` (`recipe_id`, `mat_id`, `mat_qty`) VALUES (@rec_id, 4020002, 10);

-- 配方 1-3: 蓝宝石成品 (4021003)
INSERT INTO `npc_craft_item` (`category_id`, `item_id`, `is_equip`, `yield_qty`, `req_level`, `job_name`, `cost`, `sort_order`) VALUES (@cat_gem, 4021003, 0, 1, 0, '', 450, 4);
SET @rec_id = LAST_INSERT_ID();
INSERT INTO `npc_craft_mat` (`recipe_id`, `mat_id`, `mat_qty`) VALUES (@rec_id, 4020003, 10);

-- 配方 1-4: 祖母绿成品 (4021004)
INSERT INTO `npc_craft_item` (`category_id`, `item_id`, `is_equip`, `yield_qty`, `req_level`, `job_name`, `cost`, `sort_order`) VALUES (@cat_gem, 4021004, 0, 1, 0, '', 450, 5);
SET @rec_id = LAST_INSERT_ID();
INSERT INTO `npc_craft_mat` (`recipe_id`, `mat_id`, `mat_qty`) VALUES (@rec_id, 4020004, 10);

-- 配方 1-5: 蛋白石成品 (4021005)
INSERT INTO `npc_craft_item` (`category_id`, `item_id`, `is_equip`, `yield_qty`, `req_level`, `job_name`, `cost`, `sort_order`) VALUES (@cat_gem, 4021005, 0, 1, 0, '', 450, 6);
SET @rec_id = LAST_INSERT_ID();
INSERT INTO `npc_craft_mat` (`recipe_id`, `mat_id`, `mat_qty`) VALUES (@rec_id, 4020005, 10);

-- 配方 1-6: 黄玉成品 (4021006)
INSERT INTO `npc_craft_item` (`category_id`, `item_id`, `is_equip`, `yield_qty`, `req_level`, `job_name`, `cost`, `sort_order`) VALUES (@cat_gem, 4021006, 0, 1, 0, '', 450, 7);
SET @rec_id = LAST_INSERT_ID();
INSERT INTO `npc_craft_mat` (`recipe_id`, `mat_id`, `mat_qty`) VALUES (@rec_id, 4020006, 10);

-- 配方 1-7: 钻石成品 (4021007)
INSERT INTO `npc_craft_item` (`category_id`, `item_id`, `is_equip`, `yield_qty`, `req_level`, `job_name`, `cost`, `sort_order`) VALUES (@cat_gem, 4021007, 0, 1, 0, '', 900, 8);
SET @rec_id = LAST_INSERT_ID();
INSERT INTO `npc_craft_mat` (`recipe_id`, `mat_id`, `mat_qty`) VALUES (@rec_id, 4020007, 10);

-- 配方 1-8: 黑水晶成品 (4021008)
INSERT INTO `npc_craft_item` (`category_id`, `item_id`, `is_equip`, `yield_qty`, `req_level`, `job_name`, `cost`, `sort_order`) VALUES (@cat_gem, 4021008, 0, 1, 0, '', 2700, 9);
SET @rec_id = LAST_INSERT_ID();
...
-- =========================================================================
INSERT INTO `npc_craft_cat` (`npc_id`, `menu_index`, `category_name`, `template_id`, `craft_type`, `prompt_text`, `warning_text`) VALUES
(2040016, 2, '精炼稀有宝石', 1, 'MATERIAL_BATCH', '想制作稀有宝石吗？你想制作哪一种呢？#b', '');
SET @cat_rare = LAST_INSERT_ID();

-- 配方 2-0: 稀有宝石 (4011007) - 7种矿石各1个
INSERT INTO `npc_craft_item` (`category_id`, `item_id`, `is_equip`, `yield_qty`, `req_level`, `job_name`, `cost`, `sort_order`) VALUES (@cat_rare, 4011007, 0, 1, 0, '', 9000, 1);
SET @rec_id = LAST_INSERT_ID();
...
INSERT INTO `npc_craft_item` (`category_id`, `item_id`, `is_equip`, `yield_qty`, `req_level`, `job_name`, `cost`, `sort_order`) VALUES (@cat_rare, 4021009, 0, 1, 0, '', 13500, 2);
SET @rec_id = LAST_INSERT_ID();
...
-- =========================================================================
INSERT INTO `npc_craft_cat` (`npc_id`, `menu_index`, `category_name`, `template_id`, `craft_type`, `prompt_text`, `warning_text`) VALUES
(2040016, 3, '精炼水晶矿石', 1, 'MATERIAL_BATCH', '水晶矿石吗？在这里很难找到啊...#b', '');
SET @cat_crystal = LAST_INSERT_ID();

-- 配方 3-0: 水晶成品 (4005000)
INSERT INTO `npc_craft_item` (`category_id`, `item_id`, `is_equip`, `yield_qty`, `req_level`, `job_name`, `cost`, `sort_order`) VALUES (@cat_crystal, 4005000, 0, 1, 0, '', 4500, 1);
SET @rec_id = LAST_INSERT_ID();
INSERT INTO `npc_craft_mat` (`recipe_id`, `mat_id`, `mat_qty`) VALUES (@rec_id, 4004000, 10);

-- 配方 3-1: 水晶成品 (4005001)
INSERT INTO `npc_craft_item` (`category_id`, `item_id`, `is_equip`, `yield_qty`, `req_level`, `job_name`, `cost`, `sort_order`) VALUES (@cat_crystal, 4005001, 0, 1, 0, '', 4500, 2);
SET @rec_id = LAST_INSERT_ID();
INSERT INTO `npc_craft_mat` (`recipe_id`, `mat_id`, `mat_qty`) VALUES (@rec_id, 4004001, 10);

-- 配方 3-2: 水晶成品 (4005002)
INSERT INTO `npc_craft_item` (`category_id`, `item_id`, `is_equip`, `yield_qty`, `req_level`, `job_name`, `cost`, `sort_order`) VALUES (@cat_crystal, 4005002, 0, 1, 0, '', 4500, 3);
SET @rec_id = LAST_INSERT_ID();
INSERT INTO `npc_craft_mat` (`recipe_id`, `mat_id`, `mat_qty`) VALUES (@rec_id, 4004002, 10);

-- 配方 3-3: 水晶成品 (4005003)
INSERT INTO `npc_craft_item` (`category_id`, `item_id`, `is_equip`, `yield_qty`, `req_level`, `job_name`, `cost`, `sort_order`) VALUES (@cat_crystal, 4005003, 0, 1, 0, '', 4500, 4);
SET @rec_id = LAST_INSERT_ID();
...
-- =========================================================================
INSERT INTO `npc_craft_cat` (`npc_id`, `menu_index`, `category_name`, `template_id`, `craft_type`, `prompt_text`, `warning_text`) VALUES
(2040016, 4, '制作材料', 1, 'MATERIAL_BATCH', '材料吗？我有几种可以为你制作的材料……#b', '');
...
-- =========================================================================
INSERT INTO `npc_craft_cat` (`npc_id`, `menu_index`, `category_name`, `template_id`, `craft_type`, `prompt_text`, `warning_text`) VALUES
(2040016, 5, '制作箭矢', 1, 'MATERIAL_BATCH', '箭矢吗？包在我身上！#b', '');
