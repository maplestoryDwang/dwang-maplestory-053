...
export function getCraftList(data: CraftSearchReq) {
  return axios.post('/api/npc-craft/v1/getCraftList', data);
}
...
export function saveCategory(data: NpcCraftCat) {
  return axios.post('/api/npc-craft/v1/saveCategory', data);
}
...
export function saveItem(data: NpcCraftItemForm) {
  return axios.post('/api/npc-craft/v1/saveItem', data);
}

// 7. 删除配方
export function deleteItem(data: NpcCraftItemForm) {
  return axios.post('/api/npc-craft/v1/deleteItem', data);
}

// 8. 新增或修改 NPC 台词
export function saveDialog(data: NpcDialogForm) {
  return axios.post('/api/npc-craft/v1/saveDialog', data);
}

// 9. 删除 NPC 台词
export function deleteDialog(data: NpcDialogForm) {
  return axios.post('/api/npc-craft/v1/deleteDialog', data);
}
